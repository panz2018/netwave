...
- 用 `code-review` skill 做两轴并行审查：
  - **Standards 轴**：是否合[项目宪法](constitution.md)六条铁律？有无 Fowler 坏味道（尤其 Speculative Generality——Rust 里过度造轮子）？
...
| 审查 | `code-review` | 提交前双轴：Standards（[六铁律](constitution.md)＋坏味道）× Spec（忠实度） |
